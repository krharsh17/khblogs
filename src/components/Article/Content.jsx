  ...
  return (
    <>
      <Typography
        variant={"body1"}
        component={"p"}
        style={{ color: theme.dark, margin: "4px 0", fontSize: "20px" }}
      >
        {children}
      </Typography>
      <br />
...
const ArticlePre = props => {
  return (
    <SyntaxHighlighter
      language={
        props.children.props.className !== undefined &&
        props.children.props.className.split("-")[1] !== undefined
...
const ArticleH1 = ({ children }) => {
  ...
  return (
    <Typography
      variant={"h4"}
      component={"p"}
      style={{ color: theme.dark, marginBottom: 8 }}
    >
      {children}
    </Typography>
  )
...
const ArticleH2 = ({ children }) => {
  ...
  return (
    <Typography
      variant={"h5"}
      component={"p"}
      style={{ color: theme.dark, marginBottom: 8, fontWeight: 600 }}
    >
      {children}
    </Typography>
  )
