      ...
      <HomeContainer>
        ...
        <TermsContainer>
          ...
          <ArticleTextSpan>
            ...
            https://blog.krharsh17.vision, you are agreeing to be bound by these
          ...
          <ArticleTextSpan>
            ...
            materials on KHBlogs's Website for personal, non-commercial
          ...
          <ArticleTextSpan>
            - attempt to reverse engineer any software contained on KHBlogs's
            Website;
          </ArticleTextSpan>
          <ArticleTextSpan>
          ...
          <ArticleTextSpan>
            This will let KHBlogs to terminate upon violations of any of these
          ...
          <ArticleTextSpan>
            All the materials on KHBlogs’s Website are provided "as is". KHBlogs
            makes no warranties, may it be expressed or implied, therefore
            negates all other warranties. Furthermore, KHBlogs does not make any
          ...
          <ArticleTextSpan>
            KHBlogs or its suppliers will not be hold accountable for any
            damages that will arise with the use or inability to use the
            materials on KHBlogs’s Website, even if KHBlogs or an authorize
          ...
          <ArticleTextSpan>
            The materials appearing on KHBlogs’s Website may include technical,
            typographical, or photographic errors. KHBlogs will not promise that
            any of the materials in this Website are accurate, complete, or
            current. KHBlogs may change the materials contained on its Website
            at any time without notice. KHBlogs does not make any commitment to
            update the materials.
          </ArticleTextSpan>

          <ArticleH1>6. Links</ArticleH1>
          <ArticleTextSpan>
            KHBlogs has not reviewed all of the sites linked to its Website and
            is not responsible for the contents of any such linked site. The
            presence of any link does not imply endorsement by KHBlogs of the
            site. The use of any linked website is at the user’s own risk.
          </ArticleTextSpan>

          <ArticleH1>7. Site Terms of Use Modifications</ArticleH1>
          <ArticleTextSpan>
            KHBlogs may revise these Terms of Use for its Website at any time
          ...
          <ArticleTextSpan>
            Any claim related to KHBlogs's Website shall be governed by the laws
